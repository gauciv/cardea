    ...
    <div ref={containerRef}>
        ...
        >
          <div className="flex items-center justify-center px-3 mr-3">
            <img
              ...
              style={{
                filter: navCompact
                  ? "brightness(1.15) drop-shadow(0 0 8px rgba(74, 158, 218, 0.3))"
                  : "brightness(1)",
                userSelect: "none",
                pointerEvents: "none",
              }}
      ...
      {phase !== "final" && (
        <div
          ...
          style={{
            ...
            transition:
              phase === "transitioning" ? "none" : "all 0.3s ease-out",
            zIndex: 10,
        ...
        >
          ...
          {/* Hero Content */}
          <div
            className="flex-1 flex flex-col items-center justify-center px-4 text-center relative z-10"
          ...
          >
            <h1
              ...
              style={{
                ...
                textShadow:
                  "0 2px 4px rgba(0, 0, 0, 0.8), 0 0 30px rgba(0, 0, 0, 0.5)",
              }}
            >
              Simplified Security
              <br />
              ...
              <span
                ...
                style={{
                  textShadow:
                    "0 0 20px rgba(74, 158, 218, 0.6), 0 0 40px rgba(74, 158, 218, 0.3)",
                }}
              >
                Agentic AI
              </span>
            ...
            >
              AI-driven network security that protects, detects, and responds —
            ...
            <div className="animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <div
                className="relative h-16 w-[420px] md:w-[480px] mx-auto"
                style={{ perspective: "1000px" }}
              >
                {features.map((feature, index) => {
                  const isCurrent = index === currentFeatureIndex;
                  const isNext =
                    index === (currentFeatureIndex + 1) % features.length;
                  const isPrev =
                    index ===
                  ...
                  return (
                    <div
                      key={index}
                      className="absolute inset-0 px-6 py-4 rounded-2xl transition-all duration-500 ease-out"
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(15, 25, 45, 0.95) 0%, rgba(10, 20, 40, 0.98) 100%)",
                        backdropFilter: "blur(20px)",
                        border: isCurrent
                          ? "1px solid rgba(74, 158, 218, 0.4)"
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(0deg, rgba(38, 116, 178, 0.9) 0%, rgba(38, 116, 178, 0.5) 20%, rgba(38, 116, 178, 0.15) 40%, transparent 60%)",
            maskImage:
              "radial-gradient(ellipse 15% 100% at 50% 100%, black 0%, transparent 100%)",
            WebkitMaskImage:
              "radial-gradient(ellipse 15% 100% at 50% 100%, black 0%, transparent 100%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 50% 60% at 50% 100%, rgba(38, 116, 178, 0.2) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse 30% 20% at 50% 100%, rgba(100, 180, 255, 0.4) 0%, transparent 60%)",
          }}
        />

        <div
          className={`relative z-10 w-full px-8 md:px-16 lg:px-24 transition-all duration-1000 ${
            featuresVisible
      ...
      {phase === "final" && (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(74, 158, 218, 0.1) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="relative min-h-screen flex flex-col">
            {/* Tab Navigation */}
            <div
              className={`pt-20 border-b border-gray-700/50 transition-all duration-700 ${
                useCasesVisible
                  ? "opacity-100 translate-y-0"
            ...
            {/* Content Area */}
            <div
              className={`max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-16 md:py-24 transition-all duration-1000 delay-200 ${
                useCasesVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-12"
              }`}
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(15, 25, 45, 0.9) 0%, rgba(10, 20, 40, 0.95) 100%)",
                      border: "1px solid rgba(74, 158, 218, 0.2)",
                      boxShadow:
                        "0 20px 60px rgba(0, 0, 0, 0.5), 0 0 40px rgba(38, 116, 178, 0.1)",
                    }}
                  >
                    {/* Visual Header */}
                    ...
                    <div className="p-6">
                      {useCaseTabs[activeTab].visual.type === "alert" && (
                        <div className="space-y-3">
                          {(
                            useCaseTabs[activeTab].visual.data as Array<{
                              severity: string;
                              message: string;
                              time: string;
                            }>
                      ...
                      {useCaseTabs[activeTab].visual.type === "network" && (
                        <div className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            {Object.entries(
                              useCaseTabs[activeTab].visual.data as {
                                devices: number;
                                activeFlows: string;
                                bandwidth: string;
                                anomalies: number;
                              ...
                              <div
                                key={idx}
                                className="p-4 rounded-lg bg-[#0a1525] border border-gray-700/50"
                              >
                                <div
                                  className="text-2xl font-bold text-[#4a9eda]"
                                  style={{ fontFamily: "Nunito, sans-serif" }}
                                >
                                  {value}
                                </div>
            ...
            {/* Footer */}
            <div
              className={`border-t border-gray-600/30 py-12 mt-auto transition-all duration-700 delay-500 ${
                useCasesVisible ? "opacity-100" : "opacity-0"
              }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p
                      ...
                      style={{ fontFamily: "Nunito, sans-serif" }}
                    >
                      AI-powered network security that protects, detects, and
                ...
                <div className="pt-8 border-t border-gray-700/50 flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    <a
                      ...
                      className="text-gray-500 hover:text-[#4a9eda] transition-colors"
                    >
